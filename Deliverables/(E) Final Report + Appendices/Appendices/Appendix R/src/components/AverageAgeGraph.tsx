...
StateData.sort((a, b) => parseInt(a.AverageAgeRank) - parseInt(b.AverageAgeRank))
...
export default function AverageAgeGraph(props) {

  const MLData = {
    labels,
    datasets: [
      {
        label: '% Positive Sentiment, ordered by highest Average Age on the left, lowest on the right. (As classified by the ML Model)',
        data: pSentiment,
        borderColor: 'green',
        backgroundColor: 'green',
      },
      {
        label: '% Negative Sentiment, ordered by highest Average Age on the left, lowest on the right. (As classified by the ML Model)',
        data: nSentiment,
        borderColor: 'red',
        backgroundColor: 'red',
      },
  ...
  const ManualData = {
    ...
    datasets: [
      {
        label: '% Positive Sentiment, ordered by highest Average Age on the left, lowest on the right. (As classified by Hand)',
        data: tPSentiment,
        borderColor: 'green',
        backgroundColor: 'green',
      },

...
import AverageAgeGraph from "./AverageAgeGraph.tsx"

function AverageAge(props) {
    return(
        <div>
            <Container>
                ...
                <Card.Body>
                    ...
                    <Card.Text>
                    <p>
                        Following are the graphs that show the Sentiment for States. The data is displayed in line graphs with the furthest left states having the highest average age, and the furthest right having the lowest average age. This was done to allow any trends to easily visually detectable.
                    </p>
                    <p>

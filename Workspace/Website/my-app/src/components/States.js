...
function States() {
    ...
    console.log(options[selectedValue].label)
                ...
                <CardGroup>
                    <Card>
                        <Card.Body>
                            ...
                            <p>
                                However, the use of the data is not limited at that, use the dropdown menu on the right hand side to explore the "raw" data for individual states.
                            </p>
                            <p>

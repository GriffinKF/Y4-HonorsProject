...
import AverageSalaryGraph from "./AverageSalaryGraph.tsx"
        ...
        <div>
            <Container>
                ...
                <Card.Body>
                    ...
                    <Card.Text>
                    <p>
                        Following are the graphs that show the Sentiment for States. The data is displayed in line graphs with the furthest left being ranked highest in average household income, and the furthest right being states ranked lowest in average household income. This was done to allow any trends to easily visually detectable.
                    </p>
                    <p>
